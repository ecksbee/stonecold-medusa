            ...
            <div className={styles.padded}>
                <div className={styles.scroll}>
                    ...
                    <form onSubmit={async e => await signup(e)}>
                        ...
                        <div>
                            {hcaptcha && <button className={styles.btnSubmit} type='submit'>Sign me up</button>}
                            {!hcaptcha && <button className={styles.btnDisabled} type='button'><s>Sign me up</s></button>}
                        </div>
                    </form>
                </div>
            </div>
